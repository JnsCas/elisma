...
;+(function (root) {
  ...
  var Perlin = function Perlin() {
      ...
      this.p = [
        ...
        ,
      ]
...
window.addEventListener('load', function () {
  var rctx = new SmallPRNG(+new Date()), // random generator, see ref
    ...
    width,
    height,
    bounds = new Vector3D(0, 0, 0).moveTo(200, 100)
  const settings = {
    particleNum: 10500,
    fadeOverlay: true,
    rotateColor: false,
    staticColor: { r: 0, g: 75, b: 50 },
    staticColorString: 'rgba(0, 75, 50, 1)',
  }
  var background = new Image()
  background.src = '/assets/images/ismael.png'
  ...
  resize = function () {
    // resize the canvas
    canvas.width = width = bounds.x = background.width
    canvas.height = height = bounds.y = background.height
    bounds.x = 680
    bounds.y = 280
    // remove this and see weird gorgeous stuffs, the history of particles.
    //context.fillStyle = '#ffffff';
    //context.fillRect(90, 90, width, height);
    //context.arc(600, 600, 500, 0, 2 * Math.PI);
  }
  resize()
  ...
  for (var i = 0; i < settings.particleNum; i += 1) {
    ...
    particles.push(new Particle(p, new Vector3D(680, 450, 0).moveTo(530, 200), rctx, monitor))
    particles.push(new Particle(p, new Vector3D(750, 350, 0).moveTo(530, 200), rctx, monitor))
  }
